...
//go:generate swagger generate server --target ../../generated --name CalculatronService --spec ../../api/swagger.yaml --principal interface{} --exclude-main

func configureFlags(api *operations.CalculatronServiceAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.CalculatronServiceAPI) http.Handler {
